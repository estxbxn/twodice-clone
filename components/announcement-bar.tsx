  ...
  return (
    <div className="mt-4 w-full">
      <div className="rounded-xl md:rounded-2xl bg-[linear-gradient(90deg,theme(colors.fuchsia.500),theme(colors.indigo.400),theme(colors.cyan.400),white,theme(colors.cyan.400),theme(colors.indigo.400),theme(colors.fuchsia.500))]">
        <div className="text-xs md:text-sm text-black/90 px-3 md:px-4 py-4 flex items-center justify-between gap-3 bg-white/70 rounded-[10px] md:rounded-[14px] backdrop-blur">
          ...
          <Button
            variant="link"
            size="icon"
            className="w-auto h-auto text-black/90"
